% RSKTOOLS
% version 1.1 3/May/2013
% changes: added burst and event readers
%
% 1.  This toolbox depends on the presence of a functional mksqlite
% library.  We have included a couple of versions here for 32 bit Windows
% and 64bit Macs, but you might need to compile another version.  The
...
% and <endtime> values are the range of data that should be read.  Depending
